...
@Experiment.register("exp6")
class Exp6(Experiment):
    ...
    def __call__(self) -> Tuple[List[str], List[str]]:
        ...
        self.datasets['train'] = self.datasets['train'].remove_columns(
            'subject')
    ...
    def info(self) -> str:
        return "Transfer-Learning: Apply Fine-Tunning technique using the labeled data"
